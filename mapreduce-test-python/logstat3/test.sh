...
/usr/local/hadoop/bin/hdfs dfs -copyFromLocal /logstat2/output/part-00000 /logstat3/input/
...
# /usr/local/hadoop/bin/hdfs dfs -cat /logstat3/output/count_by_hour.txt
# /usr/local/hadoop/bin/hdfs dfs -rm -r /logstat3/input/
# /usr/local/hadoop/bin/hdfs dfs -rm -r /logstat3/output/
# ../../stop.sh
